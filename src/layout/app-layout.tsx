...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'customer-service-representative', 'van-maintenance-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Van', path: '/vans', entity: 'van', service: AccessServiceEnum.PROJECT, icon: FiTruck },
