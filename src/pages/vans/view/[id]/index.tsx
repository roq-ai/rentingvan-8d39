...
import { getVanById } from 'apiSdk/vans';
...
function VanViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<VanInterface>(
    ...
    () =>
      getVanById(id, {
        relations: ['organization', 'booking', 'maintenance'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('van', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/vans/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/bookings/create?van_id=${data?.id}`}>
              ...
              {hasAccess('maintenance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/maintenances/create?van_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
